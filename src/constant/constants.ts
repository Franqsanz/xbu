...
const categories: Array<SelectBooksType> = [
  ...
  { value: 'Literatura Juvenil', label: 'Literatura Juvenil' },
  ...
  { value: 'Ocultismo', label: 'Ocultismo' },
  ...
  { value: 'Leyendas Urbanas', label: 'Leyendas Urbanas' },
  ...
  { value: 'Alta Cocina', label: 'Alta Cocina' },
